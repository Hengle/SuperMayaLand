...
void Game::Setup() 
{
    ...
    engineParameters_["WindowTitle"] = "Super Maya Land";
    engineParameters_["WindowWidth"] = 1024;
    engineParameters_["WindowHeight"] = 768;
    engineParameters_["WindowResizable"] = true;
    engineParameters_["VSync"] = true;
    engineParameters_["Multisample"] = 2;
    engineParameters_["ResourcePrefixPaths"] = ";/home/bhagabot/dev/SuperMayaLand/urho3d/bin/Data/;/home/bhagabot/dev/SuperMayaLand/urho3d/bin/CoreData/";
...
void Game::Start()
{
    ...
    std::cout << "Setup scene for rendering." << std::endl;
